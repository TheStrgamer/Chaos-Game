...
public class AffineTransform2D implements Transform2D{
  ...
  /**
   * Verifies that the given vector is not null. Throws an IllegalArgumentException if the given vector
   * is null.
  ...
  /**
   * Verifies that the given matrix is not null. Throws an IllegalArgumentException if the given matrix
   * is null.
