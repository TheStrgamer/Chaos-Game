  ...
  class PositiveTests {
    ...
    void getMinCoordsReturnsCorrectValue() {
      try {
        ...
        ChaosGameDescription chaosGameDescription = new ChaosGameDescription(new Vector2D(1, 2), new Vector2D(3, 4),
                transforms);
    ...
    class NegativeTests {
      ...
      void constructorThrowsExceptionOnNullVector1() {
        try {
          ...
          transforms.add(new JuliaTransform(new Complex(1, 3), 1));
          transforms.add(new JuliaTransform(new Complex(2, 4), -1));
          ChaosGameDescription chaosGameDescription = new ChaosGameDescription(null, new Vector2D(1,2),
                  transforms);
      ...
      void constructorThrowsExceptionOnNullVector2() {
        try {
          ...
          transforms.add(new JuliaTransform(new Complex(1, 3), 1));
          transforms.add(new JuliaTransform(new Complex(2, 4), -1));
          ChaosGameDescription chaosGameDescription = new ChaosGameDescription(new Vector2D(1, 2), null,
                  transforms);
          fail("An exception was not thrown");
        } catch (Exception e) {
          assertEquals(e.getMessage(), "Vector cannot be null");
